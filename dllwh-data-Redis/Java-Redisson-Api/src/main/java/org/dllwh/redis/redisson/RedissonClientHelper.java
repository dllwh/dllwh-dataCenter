...
public final class RedissonClientHelper {
    ...
    private static final class RedissonHelperHolder {
        static final RedissonClientHelper redissonHelper = new RedissonClientHelper();
    }
    ...
    public static RedissonClientHelper getInstance() {
        return RedissonHelperHolder.redissonHelper;
    }
